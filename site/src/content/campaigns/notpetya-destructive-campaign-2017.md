...
Maintaining offline, immutable backups with tested restoration procedures enables recovery from destructive operations. NotPetya's MBR and MFT overwrite made encrypted files unrecoverable; organizations without offline backups faced system rebuilds.
